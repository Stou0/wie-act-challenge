...
const StudentZone = () => {
  ...
  const events = [
    {
      ...
      description: 'A comprehensive introduction to robotics fundamentals, exploring basic concepts and hands-on techniques.',
      image: "/robotics.jpg"
    },
    {
      date: '12/01/2024',
      ...
      description: 'Dive into the world of artificial intelligence and explore its practical applications in modern technology.',
      image: "/iot.png"
    }
  ];
  ...
  const competitions = [
    {
      name: 'Robotics',
      status: 'OPEN',
      description: 'Design and build innovative robotic solutions that address real-world challenges.',
      icon: "/robotics.jpg"
    },
    {
      name: 'Pitching',
      status: 'OPEN',
      description: 'Develop and present groundbreaking project ideas with compelling storytelling and innovation.',
      icon: "/pitching.jpg"
    },
    {
      name: 'IOT',
      status: 'SOON',
      description: 'Explore Internet of Things technologies and create interconnected smart solutions.',
      icon: "/iot.png"
    }
  ];
  ...
  const guidanceVideos = [
    ...
    },
    {
      ...
      thumbnailSrc: '/api/placeholder/400/300',
      videoLink: '#'
    }
  ];
      ...
      <section className="bg-gradient-to-br from-purple-50 to-pink-50 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-3xl text-gray-700 mb-8 mt-6">
            Discover a variety of sessions in diverse STEM fields, led by experts in their respective domains.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12 text-lg">
            Dive into a collection of insightful videos where students share their experiences and passions in their fields of study. 
            Get inspired, learn about diverse academic journeys, and discover what makes each discipline unique.  these stories will guide you toward your future!
          </p>
