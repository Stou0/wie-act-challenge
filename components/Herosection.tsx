...
export default function WIESTARLanding() {
  ...
  const events = [
    ...
    },
    {
      ...
      description:
        "Building on the success of our first event, WIEmpowerHer 2.0 continues to inspire and empower young women in STEM. WIEmpowerHer  was an event that took place in December 2024 in “Ferchiou ”, with the goal of empowering young studnets to pursue their career in stem fields",
      activities: [
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Founded in 1963, IEEE is a leading authority in a wide variety of
          ...
          >
            ...
            <p className="text-lg text-gray-600 italic">
              Mission: To inspire, empower, and support women in technological
              fields, breaking down barriers and creating opportunities for
      ...
      <div className="container mx-auto px-4 py-16 flex-grow flex items-center">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              The IEEE Student-Teacher and Research Engineer/Scientist (STAR)
              Program is a transformative initiative designed to inspire and
              empower young girls to pursue careers in STEM.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <NetworkIcon className="text-purple-500 w-6 h-6" />
                <span className="text-gray-800">
                  Encouraging girls in mathematics, science, and engineering
                </span>
              </div>
              <div className="flex items-center space-x-3">
            ...
            >
              <a href="https://wie.ieee.org/membership/outreach/">
                {" "}
                Learn More{" "}
              </a>
